  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
        ...
        <p className='font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm'>Stay cool and stylish this summer with Nike’s latest lightweight and breathable shoes.</p>
