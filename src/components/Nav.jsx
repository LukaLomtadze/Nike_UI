  ...
  return (
    <header className='padding-x py-8 asbolute z-10 w-ful'>
        <nav className='flex justify-between items-center max-container'>
            ...
            <div className={`fixed top-0 right-0 h-full w-64 bg-[#1e1e1e] text-white transform transition-transform duration-300 z-50 ${open ? "translate-x-0" : "translate-x-full"}`}>
